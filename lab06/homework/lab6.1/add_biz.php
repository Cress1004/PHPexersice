...
<body>
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "INSERT INTO businesses (bussinesses_name, address, city, telephone, url) VALUES ('$business_name', '$address', '$city', '$telephone', '$url')";
        if (mysqli_query($conn, $sql)) {
          ...
          //  echo "New business is inserted successfully <br>";
            print "<a href='./add_biz.php'>Add Another Business</a><br/>";
        } else {
